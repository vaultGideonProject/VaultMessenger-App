...
class SharedMessageRepository(
    ...
    private val conversationRepository: ConversationRepository = ConversationRepository(errorsViewModel, context)
    ...
    suspend fun loadMessages(senderUID: String, receiverUID: String, delayMillis: Long = 10000L) {
